...
public class BufferedInputOutputStreamExample {
    public static void main(String[] args) throws IOException {
        InputStream fileInputStream = new FileInputStream("C://Users//Dell//IdeaProjects//java-io-concept//java-io-byte-streaming//src//dummyInputFile.txt");
        ...
        OutputStream fileOutputStream = new FileOutputStream("C://Users//Dell//IdeaProjects//java-io-concept//java-io-byte-streaming//src//dummyOutputFile.txt");
